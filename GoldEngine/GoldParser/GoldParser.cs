...
namespace GoldParser
{
	...
	{		
		...
		private readonly TokenStack		m_inputTokens;	// Stack of tokens to be analyzed
		private readonly TokenStack		m_outputTokens;	// The set of tokens for 1. Expecting during error, 2. Reduction
		private readonly TokenStack		m_tempStack;	// I often dont know what to call variables. 
		...
		public Parser(BinaryReader reader)
			: this()
		{
			LoadTables(new GrammarReader(reader));
		}
	...
	*/
		...
		/// </summary>
		private static bool CommentToken(Token p_token)
		{
