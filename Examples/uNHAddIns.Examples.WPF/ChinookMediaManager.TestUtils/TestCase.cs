...
namespace ChinookMediaManager.TestUtils
{
    /// <summary>
    ...
    public abstract class TestCase
    {
        ...
        {
            get { return "SessionManagement.Data.NH"; }
        }
        ...
        private static void ConfigureIoC()
        {
            ...
            container.Register(AllTypes.FromAssemblyNamed("ChinookMediaManager.DataImpl")
                                   .Where(t => t.Namespace.EndsWith("Repositories")
                                               && t.IsClass
                                               && !t.IsAbstract)
                                   .WithService.FirstInterface());

            container.Register(AllTypes.FromAssemblyNamed("ChinookMediaManager.Domain.Impl")
