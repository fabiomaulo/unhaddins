...
namespace GoldParsing.System
{
	...
	{
		private readonly List<LRAction> members= new List<LRAction>();
		...
		public IEnumerable<LRAction> Members
		{
			get { return members; }
		}
		...
		{
			members.Add(new LRAction { Symbol = p_symbol, Action = p_action, Value = p_value });
		}
		...
		public override String ToString()
		{
			...
			foreach (LRAction action in members)
			{
